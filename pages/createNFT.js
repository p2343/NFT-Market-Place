...
const projectId = "2M7hk9eJsBAWuRKMWilhOsLXd52";
const projectSecret = "0e9cdb69a73d904bfecaca1a8aca23ac";
...
export default function CreateItem(){
  ...
  async function onChange(e){
    ...
    try{
      ...
      const url = `https://ineuron-nftmarket.infura-ipfs.io/ipfs/${added.path}`;
      setFileUrl(url)
    }catch(error){
